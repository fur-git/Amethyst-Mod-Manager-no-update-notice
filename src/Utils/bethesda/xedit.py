...
the plugins.txt / My Games links live in Utils.executables.launch; archive
download/locate/extract lives in Utils.wizards.archives.
"""
...
def persist_xedit_vfs_changes(
    ...
    from Utils.deployment.shared import _OVERWRITE_NAME, _get_staging_source_path
    from Utils.deployment.standard import _tag_mod_xedit_modified
...
def prepare_xedit_prefix(
    ...
    *,
    ...
    from Utils.executables.launch import link_mygames, link_plugins_txt
