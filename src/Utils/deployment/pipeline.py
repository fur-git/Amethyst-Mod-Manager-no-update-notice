"""
Shared deployment orchestration used by the Deploy button, Run EXE (Play),
...
def run_deploy_pipeline(
    ...
    *,
    ...
    confirm_downgrade
        ...
        build FOSE cannot load (see Utils.bethesda.fo3_version). Called before any
    ...
    try:
        ...
        from Utils.deployment.incremental import IncrementalFallback
        ...
        if game_root and rf_allowed:
            ...
            if alias_dirs or stub_dirs:
                from Utils.deployment.shared import (create_probe_stub_dirs,
        ...
        try:
            from Utils.deployment.shared import _flush_deferred_deploy_snapshots
        ...
        if incr_plan is not None:
            ...
            _tag = ""
        from Utils.filegraph.deploy import finish as finish_filegraph_deployment
