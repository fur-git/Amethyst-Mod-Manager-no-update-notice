"""
deployment/shared.py
Shared primitives used by the deploy_* mode modules.

Extracted from the deployment façade during the 2026-04 refactor. No behaviour
changes; the package façade re-exports everything here via `from ... import *`.
"""
...
def _catalog_custom_deploy_list(
    ...
    if game is None:
        return []
    from Utils.filegraph.deploy import absolute_destination, deployed_entries_for
