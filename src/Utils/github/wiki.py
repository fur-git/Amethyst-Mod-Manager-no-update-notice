...
Everything goes through :mod:`Utils.github.cache`, which adds ETag conditional
...
from Utils.github.cache import fetch, fetch_text
...
#: :mod:`Utils.profiles.export` followed by its urlsafe-base64 payload. The
