...
the Steam/Heroic integrations re-enumerate the disk on every call, so calling
...
from Utils.launchers.steam import find_steam_libraries, _parse_acf_installdir
...
class InstalledIndex:
    ...
    def _build_shortcuts(self) -> None:
        ...
        try:
            from Utils.launchers.steam_shortcuts import build_installed_exe_index
    ...
    def _build_lutris(self) -> None:
        ...
        try:
            from Utils.launchers.lutris import build_installed_exe_index
    ...
    def _build_faugus(self) -> None:
        ...
        try:
            from Utils.launchers.faugus import build_installed_exe_index
