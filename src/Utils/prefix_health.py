...
Import rule, load-bearing: this module must never import ``Utils.protontricks``
...
def check_game_registry(
    ...
    Steam and ``bethesda_registry`` both write the Wow6432Node view (Wine's
    ...
    if game_path is not None:
        try:
            from Utils.bethesda_registry import _posix_to_wine_path
...
def check_proton_binding(
    ...
    try:
        ...
        from Utils.protontricks import prefix_downgrade_warning
