...
from Utils.bsa.writer import is_packable, _INCOMPRESSIBLE_EXT
...
def _collect_files(
    ...
    per-game allowlist lives in Utils.archives.rules.
    """
...
from Utils.bsa.writer import (  # noqa: E402  (re-export)
    is_our_stub_plugin,
    write_stub_plugin,
)
