"""Resolve the latest name-matched Nexus file for each update-flagged mod
(tkinter-free, shared by the Qt and Tk front-ends).
...
from Utils.mods.versions import resolve_latest_name_match
