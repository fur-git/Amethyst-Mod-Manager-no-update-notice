...
from Utils.filegraph_models import FileGraphCancelled, RefreshProgress
from Utils.filegraph_constants import OVERWRITE_NAME, ROOT_FOLDER_NAME
from Utils.filegraph_archives import owning_plugin, pak_name_rank, scan_mod_archives
...
class GameCandidateAdapter:
    ...
    def rules_hash(self) -> bytes:
        ...
        game = self.game
        from Utils.filegraph_native import ENGINE_REVISION, RULES_REVISION
        relevant = {
    ...
    def _scan_root(self, root: Path, cancel=None) -> list[RawFile]:
        ...
        from Utils.filegraph_paths import EXCLUDE_NAMES, is_macos_junk
