"""
bsa/_selftest.py
Round-trip checks for the BSA writer. Run as a module:

    PYTHONPATH=src python3 -m Utils.bsa._selftest
...
# `Utils.bsa` imports resolve.
_SRC_ROOT = Path(__file__).resolve().parents[2]
if str(_SRC_ROOT) not in sys.path:
    sys.path.insert(0, str(_SRC_ROOT))

from Utils.bsa.extract import BsaExtractError, extract_bsa  # noqa: E402
from Utils.bsa.reader import read_bsa_file_list  # noqa: E402
from Utils.bsa.writer import (  # noqa: E402
    BsaWriteError,
    is_our_stub_plugin,
    is_packable,
    tes4_hash_file,
...
from Utils.plugins.parser import (  # noqa: E402
...
def test_filter() -> None:
    """Verify the per-game allowlist (Utils.archives.rules) - not just the
...
def test_split_textures() -> None:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        from Utils.archives.rules import texture_extensions_for_game
...
def test_oversized_file_rejected() -> None:
    ...
    from Utils.bsa import writer as bsa_writer
