...
The on-disk format is documented in ``reader.py``; the
write order is:
...
# Re-export for callers importing Utils.bsa.writer.is_packable.
from Utils.archives.rules import is_packable  # noqa: F401
...
# The existing TES4_FLAG_ESL constant in Utils.plugins.parser is 0x0200.
