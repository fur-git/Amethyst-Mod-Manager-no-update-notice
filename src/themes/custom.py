"""Persistence for user-authored theme palettes stored as JSON.

Built-in themes are Python modules under ``themes/*.py``. Custom themes
...
``themes`` discovery layer used by both the Tk and Qt front-ends.
"""
