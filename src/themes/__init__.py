...
def _iter_theme_modules() -> Iterator[str]:
    """Yield built-in palette module names."""
...
def load_palettes() -> dict[str, dict[str, str | tuple]]:
    ...
    try:
        from themes.custom import load_custom_palettes
...
def load_display_names() -> dict[str, str]:
    ...
    for mod_name in _iter_theme_modules():
        try:
            ...
            pass
    try:
        from themes.custom import load_custom_display_names
...
def get_ctk_appearance(theme_id: str) -> str:
    ...
    """
    try:
        from themes.custom import is_custom_theme, get_custom_ctk_appearance
